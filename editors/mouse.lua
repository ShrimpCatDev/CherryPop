...
function ms.draw()
    ...
    if mouse.x and mouse.y then
        ...
        drawBinary("0000000001000000011000000111000001111000011000000001000000000000",mouse.x-1,mouse.y-1,13)
        drawBinary("0100000010100000100100001000100010000100100110000110100000000000",mouse.x-1,mouse.y-1,0)
    end
end
