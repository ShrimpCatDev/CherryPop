...
function sprite:enter()
    ...
    --draw mode button
    local bos=4
    buttons.new(bos,16,8,8,"0000000000000100000011100001110000111000011100000110000000000000",3,13,function()
        self.mode="draw"
    end)
    --rectangle button
    buttons.new(bos,24,8,8,"0000000001111100010001000101111001011110011111100001111000000000",3,13,function()
        self.mode="rect"
    end)
    buttons.new(bos,32,8,8,"0000000000001000000001000111111001111110010111000100100000000000",3,13,function()
        self.mode="fill"
    end)
    buttons.new(bos,32+8,8,8,"0000000001111000011111100000000001111110000000000111111001111000",3,13,function()
        vflip()
    end)
    buttons.new(bos,32+16,8,8,"0000000000010000010101000101010011010110110101101101011000000000",3,13,function()
        hflip()
    end)
